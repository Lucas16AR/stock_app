...
export default function WhatsappButton({
  ...
  return (
    <a
      ...
      className="flex w-full items-center justify-center gap-2 rounded-full bg-[#25D366] px-6 py-3 font-semibold text-neutral-950 transition hover:brightness-105 active:scale-[0.98]"
    >
